bl_info = {
        "name": "Import GameMaker 3D Model (.txt .d3d)",
        "author": "JimmyBegg",
        "version": (1, 1),
        "blender": (2, 7, 2),
        "location": "File > Import",
        "description": "Import 3D Model for GameMaker",
        "warning": "",
        "wiki_url": "",
        "tracker_url": "",
...
class Import_gm3d(bpy.types.Operator):
        '''Imports a GameMaker Model'''
        bl_idname = "import_object.txt"
        bl_label = "Import GameMaker 3D Model (.txt .d3d)"
...
def menu_func(self, context):
        self.layout.operator(Import_gm3d.bl_idname, text="GameMaker Model Import (.txt .d3d)")
